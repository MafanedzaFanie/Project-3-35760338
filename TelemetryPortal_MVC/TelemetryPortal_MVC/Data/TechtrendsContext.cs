...
public partial class TechtrendsContext : DbContext
{
    ...
    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
    {
        ...
        {
            optionsBuilder.UseSqlServer("Persist Security Info=True;User ID=serviceadmin;Initial Catalog=Project2DB;Data Source=zaazrproject2cmpg323.database.windows.net");
        }
    }
